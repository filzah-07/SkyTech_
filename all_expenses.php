        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              <li>
                <a href="mainMenu.php"> Issues </a>
              </li>
              <li>
                <a href="inventory.php"> Inventory </a>
              </li>
              <li>
                <a href="all_expenses.php" class="active"> Expenses </a>
              </li>
            </ul>
          </li>
      ...
      <section class="section">
        <div class="container-fluid">
          ...
          ?>
            ...
            $query = "SELECT YEAR(date) AS year, SUM(average_price) AS total_price FROM all_expenses GROUP BY YEAR(date)";
