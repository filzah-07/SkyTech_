                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="min-width">
                            <p>SCU - SYSTEM CONTROL UNIT</p>
                          </td>
                          <td class="min-width">
                            <p><a href="#0">2022-12-12</a></p>
                          </td>
                          <td>
                            <span class="status-btn close-btn">Urgent</span>
                          </td>
                          <td class="min-width">
                            <p>Expected</p>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="min-width">
                            <span class="status-btn active-btn">Moderate</span>
                          </td>
                          <td class="min-width">
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="status-btn success-btn">Low</span>
                          </td>
                          <td class="min-width">
                            <p>Done</p>
                          </td>
