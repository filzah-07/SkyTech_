          ...
          <div class="row">
            <div class="col-xl-4 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Total Expenses/Daily</h6>
                  <h3 class="text-bold mb-10">RM 74,567</h3>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Total Expenses/Month</h6>
                  <h3 class="text-bold mb-10">RM 74,567</h3>
            ...
            <div class="col-lg-6">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-10">Overall Expenses by Parts</h6>
                    <h3 class="text-bold">RM 245,479</h3>
                  </div>
                  <div class="right">
            ...
            <div class="col-lg-6">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap align-items-center justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-10">Statistics</h6>
                    <h3 class="text-bold">RM 45,479</h3>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
